...
const appRoutes: Routes = [
    ...
    { path: 'dance-moves', component: DanceMovesComponent, children: [
        ...
        { path: ':id', component: DanceMovesDetailsComponent, resolve: [DanceMovesResolverService] },
        { path: ':id/edit', component: DanceMoveEditComponent, resolve: [DanceMovesResolverService] }
    ] }
];
